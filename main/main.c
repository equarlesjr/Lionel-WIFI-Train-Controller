...
static const httpd_uri_t __attribute__((unused)) any = {
    .uri       = "/any",
    .method    = HTTP_ANY,
    .handler   = any_handler,
    /* Let's pass response string in user
...
static const httpd_uri_t __attribute__((unused)) ctrl = {
    .uri       = "/ctrl",
    .method    = HTTP_PUT,
...
#if !CONFIG_IDF_TARGET_LINUX
        train_http_register_uri_handlers(server);
#endif
#if CONFIG_EXAMPLE_ENABLE_SSE_HANDLER
